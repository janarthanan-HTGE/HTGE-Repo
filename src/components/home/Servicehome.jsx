        ...
        <div className="service-inner">
          ...
          <div className="row mt-4">
            <div
              ...
              className="col-xl-4 col-lg-4 col-md-6 col-12 fade-up"
            >
              <div className="single-service-item">
                <div className="shape">
                  <img className="shape-3" src="/assets/img/service/shape-1.png" alt="" />
                  <img className="shape-4" src="/assets/img/service/shape-2.png" alt="" />
                </div>
                <div className="image">
            ...
            >
              <div className="single-service-item">
                ...
                <div className="content">
                  <div className="icon">
                    <i className="flaticon-usability"></i>
                  </div>
                  <h4>QA & Testing</h4>
                  <p>
                    We’ll match you to an entire remote team of incredible
